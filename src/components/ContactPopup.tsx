        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={() => setIsModalOpen(false)}>
          ...
          >
            ...
            <div className="flex justify-center gap-5 mb-6">
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-12 h-12 rounded-full bg-green-600/20 flex items-center justify-center hover:bg-green-600/30 transition">
              ...
              <a href={`tel:${phone}`} aria-label="Позвонить" className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center hover:bg-blue-600/30 transition">
              ...
              <a href="https://s.imoim.net/jH2Eza" target="_blank" rel="noopener noreferrer" aria-label="Написать в IMO" className="w-12 h-12 rounded-full bg-amber-600/20 flex items-center justify-center hover:bg-amber-600/30 transition">
                <img src="/imo-icon.svg" alt="IMO" className="w-6 h-6" />
              </a>
              <a href={telegramUrl} target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="w-12 h-12 rounded-full bg-sky-600/20 flex items-center justify-center hover:bg-sky-600/30 transition">
