        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-4">
            <motion.img
              ...
              src={heroImg}
              alt="Нина Ивановна"
              className="w-full rounded-sm border border-gold/15"
            />
            <motion.img
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
          ...
          >
            ...
            <div className="pt-4 border-t border-gold/15">
              <p className="text-gold/80 text-sm font-medium mb-4">Не откладывайте решение своих проблем! Обращайтесь ко мне прямо сейчас. Онлайн консультация 24 часа!</p>
              <div className="flex flex-wrap gap-4">
                <a href="tel:+79045890444" className="text-gold hover:text-gold/80 transition text-sm">+7 (904) 589 04 44</a>
                <a href="https://wa.me/79045890444" className="text-gold hover:text-gold/80 transition text-sm">WhatsApp</a>
                <a href="https://t.me/+79045890444" className="text-gold hover:text-gold/80 transition text-sm">Telegram</a>
              </div>
            </div>
          </motion.div>
        </div>
